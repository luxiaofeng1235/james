...
$condition = "( instr(source_url,'http')>0 or instr(source_url,'qijitushu')>0 ) and id<30000 ";
...
echo "共有 {$count}本书需要去同步 ,一共有{$allpages}页数据，每页配置{$limit}条数据\r\n";
...
//     echo "list of  current_pages page = (".($i+1)."/".($allpages).") \r\n" ;
// }
...
* @return array
*/
function synFileToOss($chapterInfo=[],$id,$len_size = 300){
    if(!$chapterInfo){
        return false;
    }
